...
<div class='form-group'>
    ...
    echo form_input(array('name'=>'txtPrixHT','value'=>'','required'=>'required','pattern'=>'.{0,}','title'=>'Le Prix ht doit etre uniquement composer de chiffre','class'=>'form-control'));
    
    echo form_label('NomImage', 'Lblimage');

    echo form_input(array('name'=>'txtImage','type'=>'file','class'=>'form-control'));
